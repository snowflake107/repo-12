...
<Youtube video="ur9Qe2sZEOw" title="Speculative checks demo"/>
...
<Image src={specChecksListScreenshot} alt="Mergify speculative checks" />
...
<Image src={specChecksDetailsScreenshot} alt="Mergify speculative checks details" />
